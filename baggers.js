var data = {
  speakers: [
    ...
    },
    {
      since: '2018-10-01',
      name: 'Éric Le Merdy',
      bio: 'Tech Lead @One2Team',
      picture:
        'https://fr.gravatar.com/userimage/6479044/fc21a54aab01f19384ea2f2083d07eae.jpeg?size=200',
      websites: [
        {
          name: 'Web',
          url: 'http://eric.lemerdy.name/',
        },
      ],
      location: 'Paris, remote',
      sessions: [
        {
          title:
            'Scaling web application : from monolith AngularJS to modular react components',
          abstract:
            "<<I'll need a month refactoring before this feature can be implemented>>, <<I will finish next sprint>> (saying the same since 3 sprint), <<We have unexpected behavior>>, <<This is legacy code from last sprint>>. I am sure you already heard that... In this presentation, I will describe the magnitude of mess left by our webapp that has not grew very softly. Events, javascript object references, scope, angular state in services singletons, etc. The big ball of mud. How we escaped from this nightmare. You will see how Redux has stabilized our state management, React introduces better component oriented design and performance and finally RxJS decoupled components life cycle from data life cycle !",
          tags: ['AngularJS', 'ReactJS', 'Architecture', 'Frontend'],
          lang: ['fr', 'en'],
        },
      ],
      cities: ['Paris'],
